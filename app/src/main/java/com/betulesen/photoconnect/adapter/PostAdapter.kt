package com.betulesen.photoconnect.adapter

import android.view.LayoutInflater
import android.view.ViewGroup
import androidx.recyclerview.widget.RecyclerView
import com.betulesen.photoconnect.databinding.RecyclerRowBinding
...
class PostAdapter(private val postList : ArrayList<Post>) : RecyclerView.Adapter<PostAdapter.PostHolder>() {
    ...
    override fun onBindViewHolder(holder: PostHolder, position: Int) {
        ...
        holder.binding.recyclerCommenText.text =postList[position].description
